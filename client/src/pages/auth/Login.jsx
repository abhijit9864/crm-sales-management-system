        ...
        <div className="min-h-screen bg-[#F5F8FE] text-[#232529]">
            <div className="grid min-h-screen lg:grid-cols-2">
                ...
                <section className="flex items-center justify-center px-6 py-10 sm:px-10 lg:px-16 xl:px-24">
                  ...
                  <label
                    htmlFor="email"
                    className="mb-2 block font-inter text-sm font-semibold text-[#31373D]"
                  >
                    Email address
                  </label>
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="h-12 w-full rounded-xl border border-[#D3D5D9] bg-white pl-11 pr-4 font-inter text-sm text-[#232529] outline-none transition-all placeholder:text-[#B2B6BD] hover:border-[#B2B6BD] focus:border-[#266DF0] focus:ring-4 focus:ring-[#D9E5FC]"
                    />
                  </div>
                </div> */}
                  ...
                  <div className="group relative">
                    ...
                    <input
                      ...
                      required
                      className="h-12 w-full rounded-xl border border-[#D3D5D9] bg-white pl-11 pr-12 font-inter text-sm text-[#232529] outline-none transition-all placeholder:text-[#B2B6BD] hover:border-[#B2B6BD] focus:border-[#266DF0] focus:ring-4 focus:ring-[#D9E5FC]"
                    />
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg text-[#9CA1AA] transition-colors hover:bg-[#F5F8FE] hover:text-[#266DF0]"
                    >
                      {showPassword ? (
                        <EyeOff size={18} />
                      ) : (
                        <Eye size={18} />
                                ...
                                {/* <button
                  type="submit"
                  className="group flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#266DF0] font-inter text-sm font-semibold text-white shadow-[0_10px_24px_rgba(38,109,240,0.22)] transition-all hover:-translate-y-[1px] hover:bg-[#1F62DD] hover:shadow-[0_14px_28px_rgba(38,109,240,0.28)] active:translate-y-0"
                >
                  Sign in
                  ...
                  />
                            ...
                            <div className="mt-6 flex items-center justify-center gap-2 border-t border-[#EDEEF0] pt-5">
                                <ShieldCheck size={15} className="text-[#266DF0]" />
                    ...
                    <div className="relative flex w-full flex-col justify-between p-12 xl:p-16">
                        ...
                        <div className="max-w-xl">
                            ...
                            <p className="mt-6 max-w-lg font-inter text-[15px] leading-7 text-[#9CA1AA]">
                                Track your entire sales journey in one place — from the first
                                conversation to the final deal closure.
                            </p>
